...
const { FiClock, FiPlus, FiEdit, FiTrash2, FiUser, FiMove, FiDollarSign, FiTrendingUp } = FiIcons;
...
const ProgramChapter = () => {
  ...
  const syncToBudget = () => {
    ...
    // In a real app, this would update shared state or database
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <Card padding="normal" className="text-center">
          <div className="text-2xl font-bold text-orange-600">
            {events.filter(e => e.owner).length}
          </div>
